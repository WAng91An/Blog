...
import com.wrq.utils.TmStringUtils;
...
public class TmIpUtil {
	...
	public static String ipLocation(String ip) {
		try {
			String ipLocation = "";
			String ippath = ResourceUtils.getFile("classpath:ip").getAbsolutePath();
			TmIPSeeker ipSeeker = new TmIPSeeker("qqwry.dat", ippath);
...
//		System.out.println(ipLocation("202.101.108.207"));
		...
		System.out.println(ipLocation("120.192.177.21"));
	}
